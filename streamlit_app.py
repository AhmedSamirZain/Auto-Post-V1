...
import os, sys, asyncio, datetime, threading, logging
...
# ── تشغيل البوت تلقائيًا في خلفية ثريـد منفصل ──
bot_thread = None
...
def _start_bot():
    ...
    bot_thread = threading.Thread(target=_run, daemon=True, name="bot-worker")
    bot_thread.start()
